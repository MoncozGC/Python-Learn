...
# Desc  :
# py: https://codeantenna.com/a/GFvpVOc3yG;
# xlwt: https://www.jianshu.com/p/b7c387a84204  https://www.jianshu.com/p/4e39444d5ebc https://blog.csdn.net/zhouz92/article/details/106833511
#  https://zhuanlan.zhihu.com/p/153520229 https://www.jianshu.com/p/b7c387a84204
...
where a.wareid=b.wareid and a.wareid=c.wareid and c.parentcode='03' """
    ...
    save_dir = current_dir + "File_" + "%s.xls" % aa
    book.save(save_dir)
